...
//  drawBox();
 Serial.begin(9600);
  gotoXY(0,0);
//  LcdString("Order No:121");
//  drawLine();
//  LcdString(" Order Count");
//  gotoXY(0,2);
//  LcdString("1. itemno1 2");
//  LcdString("2. itemno2 3");
//  LcdString("3. itemno3 6");
//  LcdString("4. itemno4 5");
//  LcdString("5. itemno4 7");
...
character[0] = Serial.read();
 ...
 LcdCharacter(character[0]);
Serial.write(character[0]);

}
//} else {
//  LcdString("not showing");
//}
//LcdString("sd");
}
